...
void draw_game(Game* game)
{
	...
	glRotatef(game->ball.currentRotation, 0, 0, 1);
	...
	glRasterPos2f(25, 25);
	itoa(game->leftPoints, pointString, 8);	
	glutBitmapString(GLUT_BITMAP_TIMES_ROMAN_24, pointString);
	
	glRasterPos2f(game->width-25, 25);
	itoa(game->rightPoints, pointString, 8);	
	glutBitmapString(GLUT_BITMAP_TIMES_ROMAN_24, pointString);
